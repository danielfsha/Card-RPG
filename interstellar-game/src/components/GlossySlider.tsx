...
const GlossySlider: React.FC<GlossySliderProps> = ({ 
  ...
  const updateValue = useCallback((clientX: number) => {
    ...
    if (newValue !== value) {
      console.log('[GlossySlider] Updating value from', value, 'to', newValue);
      onChange(newValue);
    }
  ...
  const handleTouchStart = (e: React.TouchEvent) => {
    // Note: preventDefault is called but React's synthetic events handle this
    // The actual touch event listener is added with passive: false in useEffect
