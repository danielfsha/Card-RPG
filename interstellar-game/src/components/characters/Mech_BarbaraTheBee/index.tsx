...
export function Model({ animation = 'Idle', ...props }: ModelProps) {
  ...
  const { nodes, materials, animations } = useGLTF('/Characters/GLTF/Mech_BarbaraTheBee.gltf') as unknown as GLTFResult & { animations: THREE.AnimationClip[] }
...
useGLTF.preload('/Characters/GLTF/Mech_BarbaraTheBee.gltf')
