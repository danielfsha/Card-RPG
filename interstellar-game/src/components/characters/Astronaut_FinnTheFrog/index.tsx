...
export function Model({ animation = 'Idle', ...props }: ModelProps) {
  ...
  const { nodes, materials, animations } = useGLTF('/Characters/GLTF/Astronaut_FinnTheFrog.gltf') as unknown as GLTFResult & { animations: THREE.AnimationClip[] }
...
useGLTF.preload('/Characters/GLTF/Astronaut_FinnTheFrog.gltf')