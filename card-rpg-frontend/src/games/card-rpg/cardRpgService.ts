...
/**
 * Service for interacting with the CardRpg game contract
 */
export class CardRpgService {
  private baseClient: CardRpgClient;
  private contractId: string;

  constructor(contractId: string) {
    this.contractId = contractId;
    // Base client for read-only operations
    this.baseClient = new CardRpgClient({
  ...
  private createSigningClient(
    ...
    return new CardRpgClient(options);
  }
...
// Example: const cardRpgService = new CardRpgService(contractId);
